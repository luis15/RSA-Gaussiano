\pagestyle{fancy}
\fancyhead[C]{\textsl{3. Adentrando nos inteiros Gaussianos}}
\fancyhead[R]{\thepage}
\fancyfoot[C]{}


\chapter {Adentrando nos inteiros Gaussianos}
\label{RSAG}

Chegamos ao \'ultimo cap\'itlo desta obra, aqui ser\'a debatido sobre tudo o que foi alcançado at\'e o momento no que diz respeito ao RSA Gaussiano, veremos como sua f\'ormula \'e planejada e o que ter\'a de ser feito no futuro para que este algoritmo se torne uma opção entre os algoritmos criptogr\'aficos.
