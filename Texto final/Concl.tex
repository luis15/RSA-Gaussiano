...
Nesta sess\~ao n\'os viremos a fazer as \'ultimas considera\c{c}\~oes sobre a viabilidade do algoritmo RSA Gaussiano. Al\'em disso vamos ver o que outros pesquisadores j\'a est\~ao concluindo em suas pesquisas.

A primeira coisa que devemos prestar aten\c{c}\~ao \'e que no decorrer deste artigo n\~ao viemos a encontrar nada que impedisse a realiza\c{c}\~ao de uma criptografia RSA Gaussiana, mas como foi visto no cap\'itulo \ref{IG}, ainda faltam a comprava\c{c}\~ao de alguns teoremas matem\'aticos importantes para a realiza\c{c}\~ao da criptografia RSA Gaussiana. 
