...
Al\'em desses resultados apresentados acima ouros ainda nos s\~ao necess\'arios para a realiza\c{c}\~ao de uma criptografia RSA Gaussiana, como uma aritm\'eica modular gaussiana e teorema an\'alogos ao teorema chin\^es do resto e ao Teorema de Fermat. No pr\'oximo cap\'itulo iremos discutir sobre a viabilidade ou n\~ao do algoritmo RSA Gaussiano, al\'em de conhecer alguns resultados relacionados a \'area pelo ponto de vista de outros pesquisadores do mesmo algoritmo.