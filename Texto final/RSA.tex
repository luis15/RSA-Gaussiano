...
O que iremos fazer nos pr\'oximo cap\'itulo, consiste em analisar a viabilidade de uma varia\c{c}\~ao da criptografia RSA que n\~ao seja completamente vulner\'avel caso uma fatora\c{c}\~ao eficiente no conjunto $\mathbb{Z}$ seja descoberta: a \textit{Criptografia RSA Gaussiana}.
