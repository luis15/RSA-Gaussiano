...
\]
\paragraph{
Porém, $3$ \'e o inverso de $6$ no m\'odulo $17$, e por isso teremos
}
\[
\begin{array}{c}
...
\[
\begin{array}{c}
$b^{3d} \equiv b \cdot (1)^{k(q-1)}\equiv b (mod p)}$
\end{array}
\]
\subparagraph{
