...
\subparagraph{
Para compreender como funciona o processo de codifica\c{c}\~ao e decodifica\c{c}\~ao faz-se necess\'ario o uso de uma série de termos t\'ecnicos, para fins pedagógicos iremos introduzir tais conceitos apresentando um dos primeiros algor\'itmos criptogr\'aficos que se tem conhecimento, a criptografia de C\'esar, al\'em de seus sucessores. 
}
\subparagraph{
